...
export const pricing = {
  ...
  title: "One clear monthly price. No per-plot surprises.",
  subtitle:
    "Start on the plan that matches how you buy. Cancel anytime while we're in early access.",
  plans: [
    {
      id: "downstream",
      name: "Downstream",
      tagline: "Buyers & traders who buy from an EU importer",
      price: "£29",
      unit: "/month",
    ...
    },
    {
      id: "operator",
      name: "Operator",
      tagline: "First importers with the full due-diligence burden",
      price: "£149",
      unit: "/month",
      annual: "or £1,490/year (two months free)",
      cta: "Get started",
      ctaKind: "signup",
      highlight: false,
      badge: null,
    ...
    },
    {
      ...
      tagline: "We prepare your first pack with you, end to end",
      price: "£500",
      unit: " one-off",
      annual: "Add to any plan",
      cta: "Book a call",
      ctaKind: "demo",
      highlight: false,
      badge: "One-off",
  ...
  footnote:
    "Prices shown are early-access rates and may change. Deforest prepares your filing; it does not submit on your behalf or guarantee a compliance outcome.",
} as const;
