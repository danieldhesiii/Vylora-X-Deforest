...
export function Trust() {
  return (
    <section className="relative bg-forest-deep py-24 text-paper-soft sm:py-28">
          ...
          {trust.cards.map((card) => (
            <RevealItem key={card.title}>
              <div className="h-full rounded-3xl border border-white/10 bg-white/[0.04] p-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 text-signal-soft">
